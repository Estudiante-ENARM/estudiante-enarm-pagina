...
// BOTÓN DE COMPRA → ENVÍA MENSAJE A WHATSAPP
if (buyAccessBtn) {
  buyAccessBtn.addEventListener("click", () => {
    const mensaje = encodeURIComponent("Me gustaría adquirir el acceso completo");
    const telefono = "525515656316"; // ← AQUI TU NUMERO SIN ESPACIOS
